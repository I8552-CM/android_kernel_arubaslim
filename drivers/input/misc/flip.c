...
/////////////////////////////////////////////////////////////////////
extern void msmfb_switch_dual_lcd(int lcd_sel);
extern void msmfb_resume_backlight(void);
