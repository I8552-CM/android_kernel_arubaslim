...
//#define DIR_OUT(a,b) 	gpio_tlmm_config(GPIO_CFG(a, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE); \
//									gpio_set_value(a, b)		
//#define DIR_IN(a)		gpio_tlmm_config(GPIO_CFG(a, 0, GPIO_CFG_INPUT, GPIO_CFG_NO_PULL, GPIO_CFG_16MA),GPIO_CFG_ENABLE)
...
//	const char *fw_name = "mms_ts.bin";
	const char *fw_name = "tsp_melfas/arubaslim_g1f/ARUBA_SLIM_R03_VA05.fw";	//ArubaSlim&SlimQ
//	struct mms_info *info;
	printk(KERN_ERR "[TSP] %s ( %d)\n", __func__, __LINE__);
