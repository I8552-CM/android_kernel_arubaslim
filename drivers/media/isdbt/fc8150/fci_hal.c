...
#if 0 //latin_mm lkj in case of Qualcomm, SPI isn't used
...
static struct IF_PORT *ifport = &ppiif;
// u8 hostif_type = BBM_PPI;
u8 hostif_type = BBM_PPI;  // ROY_LTN_DTV uses BBM_PPI mode.
