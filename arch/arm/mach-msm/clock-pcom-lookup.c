...
*/ //kk0704.park
	...
	CLK_LOOKUP("csi_clk",		csi0_clk.c,	"msm_camera_sr200pc20.0"),
	CLK_LOOKUP("csi_pclk",		csi0_p_clk.c,	"msm_camera_sr200pc20.0"),
	CLK_LOOKUP("csi_vfe_clk",	csi0_vfe_clk.c,	"msm_camera_sr200pc20.0"),
	...
	CLK_LOOKUP("csi_clk",		csi1_clk.c,	"msm_camera_sr300pc20.1"),
	CLK_LOOKUP("csi_pclk",		csi1_p_clk.c,	"msm_camera_sr300pc20.1"),
	CLK_LOOKUP("csi_vfe_clk",	csi1_vfe_clk.c,	"msm_camera_sr300pc20.1"),
	CLK_LOOKUP("csi_clk",		csi1_clk.c,	"msm_camera_s5k4ecgx.1"),
	CLK_LOOKUP("csi_pclk",		csi1_p_clk.c,	"msm_camera_s5k4ecgx.1"),
	CLK_LOOKUP("csi_vfe_clk",	csi1_vfe_clk.c,	"msm_camera_s5k4ecgx.1"),
	...
	CLK_LOOKUP("ebi1_clk",		ebi1_clk.c,	NULL),
#ifdef CONFIG_MACH_ROY_DTV	
	CLK_LOOKUP("ebi2_clk",		ebi2_clk.c,	"isdbt"),
#else
	CLK_LOOKUP("ebi2_clk",		ebi2_clk.c,	NULL),
#endif	
	CLK_LOOKUP("ecodec_clk",	ecodec_clk.c,	NULL),
...
static struct clk_lookup msm_cmn_clk_7625a_7627a_except_uart3[] __initdata = {
	CLK_LOOKUP("core_clk",		adm_clk.c,	"msm_dmov"),
	CLK_LOOKUP("adsp_clk",		adsp_clk.c,	NULL),
	CLK_LOOKUP("master_iface_clk",		ahb_m_clk.c,	"mipi_dsi.1"),
	CLK_LOOKUP("slave_iface_clk",		ahb_s_clk.c,	"mipi_dsi.1"),
...
#endif
	CLK_LOOKUP("core_clk",		uart1dm_clk.c,	"msm_serial_hs.0"),
#ifndef CONFIG_SERIAL_MSM_HSL_CONSOLE
	CLK_LOOKUP("core_clk",		uart2dm_clk.c,	"msm_serial_hsl.0"),
#endif
	CLK_LOOKUP("core_clk",		usb_hs_core_clk.c, "msm_otg"),
	CLK_LOOKUP("alt_core_clk",	usb_hs_clk.c,	"msm_otg"),
...
static struct clk_lookup msm_clk_7627a_7625a_except_uart3[ARRAY_SIZE(msm_cmn_clk_7625a_7627a_except_uart3)
					+ ARRAY_SIZE(msm_clk_7627a)];
...
struct clock_init_data msm7x27a_clock_init_data_except_uart3 __initdata = {
	.table = msm_clk_7627a_7625a_except_uart3,
	.pre_init = msm7627a_clock_pre_init_except_uart3,
};
