...
#ifndef __GPIO_ARUBA_H_
#define __GPIO_ARUBA_H_
...
#if defined(CONFIG_MACH_ARUBA_CTC)||defined(CONFIG_MACH_KYLEPLUS_CTC)		// CTC
#define GPIO_LCD_RESET_N			22
#elif defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) 	// OPEN
...
#if defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) || defined(CONFIG_MACH_KYLEPLUS_OPEN) || defined(CONFIG_MACH_DELOS_OPEN)
#define GPIO_BT_PWR			77
#define GPIO_BT_HOST_WAKE		18
#define GPIO_BT_HOST_WAKE_GPIO34 34
#else
...
#define GPIO_BT_HOST_WAKE_rev03		83
#endif
#endif
...
#if defined(CONFIG_MACH_ARUBA_OPEN) || defined(CONFIG_MACH_ARUBASLIM_OPEN) 		// OPEN
